...
import com.moataz.mox.ui.viewmodel.IosViewModel;
...
public class IosFragment extends Fragment {
    ...
    private void getTopList() {
        viewModel.makeApiCallIosArticles().observe(requireActivity(), response -> {
    ...
    private void onSwipeRefresh() {
        binding.swipeToRefreshArticles.setOnRefreshListener(() -> viewModel.makeApiCallIosArticles().observe(requireActivity(), response -> {
            switch (response.status){
                case ERROR: {
    ...
    private void initializeViewModel() {
        viewModel = new ViewModelProvider(this).get(IosViewModel.class);
    }
}